...
const playAgainBtn = scoreSection.querySelector("#new-game-btn");
...
function drop(event) {
    ...
    if (correct === Math.min(totalMatchingPairs, totalDraggableItems)) { // Game Over!!
        ...
        setTimeout(() => {
            playAgainBtn.classList.add("new-game-btn-entrance");
        }, 200);
    }
}
...
function playAgainBtnClick() {
    playAgainBtn.classList.remove("new-game-btn-entrance");
    correct = 0;
    total = 0;
